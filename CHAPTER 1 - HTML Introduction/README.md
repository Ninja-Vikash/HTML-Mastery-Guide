...
:bulb: <b>Tip:</b>  We can write it with the help of emmet abbreviation <span style="color:blue">! + enter</span> | <span style="border:1px solid grey; border-radius:2px">html5 + enter</span> <br>
